 ...
 *
 * Firestore:
 *   /access_codes/{CODE}                    { code, promoter, active, usageCount, maxUses?, createdAt, createdBy }
 ...
 *   /usernames/{username}                   { wallet }        (top-level uniqueness registry, shared with @-mentions)
