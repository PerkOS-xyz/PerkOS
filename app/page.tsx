...
const TIERS: Tier[] = [
  {
    name: "Starter",
    price: "Free",
    cadence: "with your own AI",
    tag: "Try your first team",
    bullets: [
      "1 business team (up to 4 teammates)",
      "Connect your own AI account (OpenAI & more)",
      "You pay your AI provider directly — nothing to us",
  ...
  },
  {
    ...
    bullets: [
      "We run the AI for you — no account to set up",
      "Unlimited teams & teammates",
      "Your own saved team templates",
      "Docs, chat, full workspace & priority support",
    ],
    cta: "Start your team",
    ctaHref: "/sign-in",
    smart: true,
