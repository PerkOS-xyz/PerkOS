...
function SlidePricing() {
  const tiers = [
    ...
    { name: "Starter", price: "$29.97", tag: "We host your team · your AI key", featured: false },
    { name: "Pro", price: "$89.97", tag: "We host the team AND the AI", featured: true },
    { name: "Scale", price: "$239.97", tag: "For teams running all day", featured: false },
  ];
  return (
